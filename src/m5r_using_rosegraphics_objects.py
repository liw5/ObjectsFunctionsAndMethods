...
#           window2 = rg.RoseWindow(500,300,'graph','black','blue')
#
...
#            window3 = rg.RoseWindow(500,100,'graph','black','blue')
#
...
#        The method is necessary when the user wants to keep on looking at the window
#        because without that code, the window would close automatically.
#
#
