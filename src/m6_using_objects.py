...
def two_circles():
    window = rg.RoseWindow(500,300,'window #1')
...
def circle_and_rectangle():
    window = rg.RoseWindow(700,700,'window #2')
    ...
    corner_point1 = rg.Point(400,400)
    corner_point2 = rg.Point(300,300)

    rectangle = rg.Rectangle(corner_point1,corner_point2)
...
def lines():
    window = rg.RoseWindow(700,700,'window #3')

    start1 = rg.Point(100,100)
    end1 = rg.Point(200,200)

    start2 = rg.Point(400, 300)
    end2 = rg.Point(500, 500)
