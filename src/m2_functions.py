...
def turtle5():
    crazy_turtle1 = rg.SimpleTurtle()
    crazy_turtle1.pen = rg.Pen('red',9)

    crazy_turtle1.left(180)
    crazy_turtle1.forward(100)

    crazy_turtle2 = rg.SimpleTurtle()
    crazy_turtle2.pen = rg.Pen('black',8.5)

    crazy_turtle2.right(90)
    crazy_turtle2.forward(300)
